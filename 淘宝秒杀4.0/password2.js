...
"Microsoft Internet Explorer" == "Netscape" ? (i.prototype.am = function(t, e, n, o, i, r) {
...
,
o = 30) : "Netscape" != "Netscape" ? (i.prototype.am = function(t, e, n, o, i, r) {
    for (; --r >= 0; ) {
...
if (null == v) {
    ...
    //浏览器版本要对应！！！
    if ("Netscape" == "Netscape" && chrome_version < "5" && window.crypto && window.crypto.random) {
...
// console.log(begin("xuqien8384", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.183 Safari/537.36"))