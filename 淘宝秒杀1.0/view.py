...
from getcookies import run_cookie
...
class Make_UI():
    def __init__(self, window):
        ...
        self.ap_button = tk.Button(self.window, text="读取文件", bg="orange", font=("楷体", 12, "bold"), bd=4, width=11, height=1, command=self.account_path)
