...
timeout = 150
# frida远程IP端口
frida_host = r"172.23.10.158:10407"
# adb远程IP端口
adb_host = r"172.23.10.158:10707"
# app英文包名
...
# 工作空间的uuid路径
uuid_path = os.path.join(os.path.join(os.path.join(project_path, "workspaces"), r"detail3"), "uuid")
# hook脚本路径
hook_script = os.path.join(os.path.join(project_path, "hookscript"), r"vx_hooker_8018.js")
# 请求地址
get_url = {"detail": "http://172.23.10.70:8181/detail/8018/task?uuid={}&ip={}"}
# 回调地址
...
# 登录的微信username
username = r"v2_060000231003b20faec8c5e4881bc0ddcf0ce434b07758cd4d62871b662504c9cddc073b3a1f@finder"
# 消息通知
