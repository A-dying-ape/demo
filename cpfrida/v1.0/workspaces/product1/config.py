...
timeout = 150
# frida远程IP端口
frida_host = r"172.23.10.158:10417"
# adb远程IP端口
adb_host = r"172.23.10.158:10717"
# app英文包名
...
# 工作空间的uuid路径
uuid_path = os.path.join(os.path.join(os.path.join(project_path, "workspaces"), r"product1"), "uuid")
# hook脚本路径
hook_script = os.path.join(os.path.join(project_path, "hookscript"), r"vx_hooker_8018.js")
# 请求地址
get_url = {"product": "http://172.23.10.70:8180/product/8018/task?uuid={}&ip={}"}
# 回调地址
